...
bool Level3::playMove() {
    ...
    getLevel2Moves(checkMoves, captureMoves, stdMoves);
...
// definitely not optimal, but pressed on time.
void Level3::getLevel2Moves(vector<pair<Coord, Coord>>& checkMoves,
                            vector<pair<Coord, Coord>>& captureMoves,
                            vector<pair<Coord, Coord>>& stdMoves) 
{
